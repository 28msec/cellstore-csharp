...
- API version: vX.X.X
- SDK version: 1.0.0
- Build date: 2016-06-15T19:23:18.063+02:00
...
*DataApi* | [**EditFilings**](docs/DataApi.md#editfilings) | **PATCH** /api/filings | Update one or more filings with partial information
...
*DataApi* | [**ListDataPoints**](docs/DataApi.md#listdatapoints) | **GET** /api/data-points-for-component | Retrieve the data points for a given component. A component can be selected in several ways, for example with an accession number (AID), section URI and hypercube name, or with a CIK, fiscal year, fiscal period, and disclosure, etc.

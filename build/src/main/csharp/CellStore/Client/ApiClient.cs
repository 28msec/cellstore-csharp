...
namespace CellStore.Client
{
    ...
    public class ApiClient
    {
        ...
        public object Deserialize(IRestResponse response, Type type)
        {
            ...
            {
                return JsonConvert.DeserializeObject(response.RawBytes);
        ...
        /// <param name="queryParams">Query parameters</param>        
        public void AddPatternQueryParameters<T>(Dictionary<String, T> parameters, string pattern, Dictionary<String, String> queryParams)
        {

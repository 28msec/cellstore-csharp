...
namespace CellStore.Client
{
    ...
    public class ApiClient
    {
        ...
        /// with default configuration and base path (http://secxbrl-24-2-0.28.io/v1/_queries/public).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("http://secxbrl-24-2-0.28.io/v1/_queries/public");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://secxbrl-24-2-0.28.io/v1/_queries/public).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://secxbrl-24-2-0.28.io/v1/_queries/public")
        {
